...
<title><?= $title ?? 'TechMada RH' ?> — Espace responsable</title>
...
<div class="app-wrap">
  ...
  <aside class="sidebar">
    ...
    <ul class="sidebar-nav">
      <li>
        <a href="<?= base_url('rh/dashboard') ?>" <?= str_contains(current_url(), 'rh/dashboard') ? 'class="active"' : '' ?>>
          <i class="bi bi-grid-1x2"></i> Tableau de bord
        </a>
      </li>
      <li>
        <a href="<?= base_url('rh/demandes') ?>" <?= str_contains(current_url(), 'rh/demandes') ? 'class="active"' : '' ?>>
      ...
      <li>
        <a href="<?= base_url('rh/historique') ?>" <?= str_contains(current_url(), 'rh/historique') ? 'class="active"' : '' ?>>
          <i class="bi bi-archive"></i> Historique
        </a>
      </li>
      <li>
        <a href="<?= base_url('rh/soldes') ?>" <?= str_contains(current_url(), 'rh/soldes') ? 'class="active"' : '' ?>>
    ...
    <div class="sidebar-user">
      <div class="s-user-row">
        <div class="avatar av-blue"><?= strtoupper(substr($user['prenom'] ?? 'R', 0, 1) . substr($user['nom'] ?? 'H', 0, 1)) ?></div>
        <div>
